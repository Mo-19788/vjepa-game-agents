...
def main():
    ...
    pygame.display.set_caption("V-JEPA Pong - Planner V2")
    ...
    while running:
        ...
        if think_counter >= 6:
            ...
            # Always use planner — full V-JEPA planning mode
            action_left = planned_action
